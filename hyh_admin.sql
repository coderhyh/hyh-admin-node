/*
 ...
 Source Schema         : umabs-admin

 Target Server Type    : MySQL
 Target Server Version : 80032 (8.0.32)
 File Encoding         : 65001

 Date: 12/05/2023 00:37:24
*/
...
INSERT INTO `sys_role` (`id`, `role_name`, `role_alias`, `status`, `grade`, `create_by`, `update_by`, `create_time`, `update_time`) VALUES (2, '普通用户', '普通用户', 0, 3, 1000, 1000, '2023-04-28 00:08:23', '2023-05-05 23:04:08');
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_user` (`id`, `username`, `password`, `nickname`, `status`, `role`, `jwt`, `create_time`, `update_time`, `last_login_time`) VALUES (1000, 'admin', '21232f297a57a5a743894a0e4a801fc3', 'admin', 2, 1, 'eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6ImFkbWluIiwicGFzc3dvcmQiOiIyMTIzMmYyOTdhNTdhNWE3NDM4OTRhMGU0YTgwMWZjMyIsImlkIjoxMDAwLCJpYXQiOjE2ODM3ODIwMDcsImV4cCI6MTY4MzgyNTIwN30.ckfjV2EFx-Uv-GvYUyI5P9kElLLjJB8-Tey-MGHhQOGb44Z8tAOmU5gNJ4nY-4dN-y-tW08MaRvmyHG3h_mWOfPwNFZQQjWFJppJ40bodWfrOvleTuLaEa1qE4J7tcyo92-IjJ2wiKHtAI0ikJzduGKtghB7UhDAxdyJFB3yfmT1FLQV5T5zUrwFJfekYDIlZecABkAeIHR9D7Dd6SRXPRXZRp3RP3kWlbZlExzCvST_YXTpUIncZ98LW0GG3rVseyFLVblBVn_kofV_BHmA9vYMpWL1oKs6SfXfkYXJfg6ZhTbXJ2lYRaizzuNHP8R8W8NET0SHZoeQjbISrjfr8g', '2023-04-28 09:24:51', '2023-04-28 09:24:51', '2023-05-11 13:13:27');
...
INSERT INTO `sys_user` (`id`, `username`, `password`, `nickname`, `status`, `role`, `jwt`, `create_time`, `update_time`, `last_login_time`) VALUES (1002, 'daye.liu', '96e79218965eb72c92a549dd5a330112', '刘大爷', 0, 3, 'eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6ImRheWUubGl1IiwicGFzc3dvcmQiOiI5NmU3OTIxODk2NWViNzJjOTJhNTQ5ZGQ1YTMzMDExMiIsImlkIjoxMDAyLCJpYXQiOjE2ODM3MzgyODMsImV4cCI6MTY4Mzc4MTQ4M30.uPRiMGJV1z1YccF1a2O1ocY3ztps8zuU_FpGtCWrL61tCWjjr6U7JBZuA3OvubVDaXmId0cuFXO8EIA8knQOe5o_9ZmSo0Fj5BrtnEnaBvYYAn7l3Bb9csv8iWGyjJ_9QemArP6fSphFtXg65VtbPHmypt7YZNi3Lrm2LByLjBToswCe4Ai5tZRcgvS70Pet8vxzDnfg681j_2aIhnnBgztplBqT638TTDhs1M6t-XpWXE3KRnVoghv57F5_uLh02j9dtBPtNuOZe-yjBSfwrG2fnvf7i-0melqdxq7wu2Gw_anKEd0P5mMOBWXYuITjs6eM2D3l_pGsw75V8mY8Ww', '2023-04-28 09:25:21', '2023-04-28 09:25:21', '2023-05-11 01:04:43');
COMMIT;
